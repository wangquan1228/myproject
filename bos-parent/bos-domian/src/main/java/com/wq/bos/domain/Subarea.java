...
public class Subarea implements java.io.Serializable {
    ...
    public String toString() {
        return "Subarea [id=" + id + ", decidedzone=" + decidedzone + ", region=" + region + ", addresskey=" + addresskey
                + ", startnum=" + startnum + ", endnum=" + endnum + ", single=" + single + ", position=" + position + "]";
    }
