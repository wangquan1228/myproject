                                        ...
                                        <TABLE id=grid
                                            ...
                                            <TBODY>
                                                ...
                                                <TR
                                                    ...
                                                    <TD>
                                                    <c:if test="${linkman.lkm_gender==1}">男</c:if> 
                                                    <c:if test="${linkman.lkm_gender==2}">女</c:if> 
                                                    ...
                                                    <TD>
                                                    <a href="${pageContext.request.contextPath }/LinkManAction_getLinkManById?lkm_id=${linkman.lkm_id}">修改</a>
                                                    &nbsp;&nbsp;
                                                    <a href="${pageContext.request.contextPath }/LinkManAction_deleteLinkMan?lkm_id=${linkman.lkm_id}">删除</a>
                                                    </TD>
                                                </TR>
