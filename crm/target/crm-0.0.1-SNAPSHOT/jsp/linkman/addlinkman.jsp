...
<BODY>
	<FORM id=form1 name=form1MM
		action="LinkManAction_saveLinkMan"
		method="post">
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan="3">
								<!-- name这儿必须在cust_id前加上customer,这儿对应外键 -->
								<input type="hidden" id="cust_id" name="customer.cust_id" style="WIDTH: 180px"/>
								<input type="text" id="cust_name" name="cust_name" style="WIDTH: 180px"/>
							...
							<TR>
								...
								<INPUT class=textbox id=sChannel2
											type="text"		style="WIDTH: 180px" maxLength=50 name="lkm_name">
								</td>
								<td>联系人性别：</td>
								<td>
							...
							<TR>
								...
								<td>
								<INPUT class=textbox id=sChannel2
												type="text"		style="WIDTH: 180px" maxLength=50 name="lkm_phone">
								</td>
								<td>联系人手机 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2
											type="text"			style="WIDTH: 180px" maxLength=50 name="lkm_mobile">
								</td>
							</TR>
							<tr>
								<td rowspan=2>
