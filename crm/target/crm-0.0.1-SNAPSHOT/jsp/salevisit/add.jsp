...
<!-- 使用日期控件步骤1: 导入js和css -->
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath }/js/datepicker/datepick.css" type="text/css">
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：拜访记录管理 &gt; 添加</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<input type="text"  style="WIDTH: 180px" id="cust_name" value="${customer.cust_name}"/>
